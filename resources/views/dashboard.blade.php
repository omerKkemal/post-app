...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Chart 2: Posts Over Time - Using actual created_at data with missing dates filled
        const timeCtx = document.getElementById('timeChart').getContext('2d');

        const timeChart = new Chart(timeCtx, {
            type: 'line',
            data: {
                labels: {!! json_encode(array_keys($postsOverTime)) !!},
                datasets: [{
                    label: 'Posts Created',
                    data: {!! json_encode(array_values($postsOverTime)) !!},
                    backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    borderColor: 'rgba(59, 130, 246, 1)',
                    borderWidth: 3,
                    tension: 0.1, // Reduced tension for better zero-value representation
                    fill: true,
                    ...
                    pointRadius: function(context) {
                        // Smaller points for zero values
