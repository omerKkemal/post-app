...
<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto px-4 py-6">
            ...
            <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-100">
                ...
                <div class="flex flex-wrap gap-3" id="category-filters-container">
                    ...
                    <button class="filter-btn category-filter-btn category-filter-active" data-category="all" data-language="all">
                        <span class="category-badge" data-en="All Categories" data-har="All Categories" data-am="ሁሉም ምድቦች">All Categories</span>
                    </button>

                    <!-- Category buttons - will show names based on selected language -->
        ...
        <div id="posts-container" class="space-y-6">
            ...
            <article class="harari post-card fade-in" data-category="{{ $post->category ?? 'uncategorized' }}" data-post-id="{{ $post->id }}">
                <!-- Post header -->
            ...
            <article class="english post-card fade-in" data-category="{{ $post->category ?? 'uncategorized' }}" data-post-id="{{ $post->id }}">
                <!-- Post header -->
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center space-x-3">
            ...
            <!-- Only show Amharic posts if current route is "What's New" -->
            @if(request()->routeIs('post.view') || request()->routeIs('postView'))
                @foreach ( $posts_amharic as $post )
                <article class="amharic post-card fade-in" data-category="{{ $post->category ?? 'uncategorized' }}" data-post-id="{{ $post->id }}">
                    <!-- Post header -->
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
