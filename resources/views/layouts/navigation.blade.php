                    ...
                    <a href="{{ url('/') }}"
                       class="flex items-center space-x-3 group transition-all duration-300 hover:scale-105">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs text-gray-500 font-medium dark:text-gray-400 hidden md:block">
            ...
            <div class="flex items-center space-x-4">
                @auth
                    ...
                    <div class="hidden md:flex items-center space-x-2">
                        ...
                        <button @click="toggleTheme()"
                                class="p-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all duration-200 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-800"
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open; loadNotifications()"
                                    class="p-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all duration-200 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-800 relative"
                ...
                @else
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <a href="{{ route('login') }}"
                           class="nav-link px-4 py-2 rounded-lg transition-all duration-200 text-gray-600 hover:text-gray-900 hover:bg-gray-50 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-800">
                ...
                <!-- Mobile menu button -->
                <button class="md:hidden p-2 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-800"
